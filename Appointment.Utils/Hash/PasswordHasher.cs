...
namespace Appointment.Utils.Hash;

public class PasswordHasher
{
    public string GenerateIdentityV3Hash(string password, KeyDerivationPrf prf = KeyDerivationPrf.HMACSHA256,
    ...
    {
        var hash = new byte[1 + 4 /*KeyDerivationPrf value*/ + 4 /*Iteration count*/ + 4 /*salt size*/ +
    ...
    private static uint ConvertFromNetworkOrder(byte[] reversedUint)
    {
